...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-357"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-v1",
      "problem_contract_sha256": "4a37e1e167129cd58a555da8d1659e4a85ebbf41afb9d0fdaeac1077b15e2cc1",
      "problem_id": "problem:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd",
      "route_id": "route:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-source-fidelity-01",
      "graph_id": "graph:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $p_1,p_2,p_3,\\ldots$ be a sequence of points in ${\\mathbb R}^d$ with the property that for every $i \\ge d+2$, the points $p_{i-1}, p_{i-2}, \\ldots p_{i-d-1}$ are distinct, lie on a unique sphere, and further, $p_i$ is the center of this sphere. If this sequence is periodic, must its period be $2d+4$?"
          },
          "statement_sha256": "e8224287a8ca4766c6db905596432d40394d1668359ef2bcc6118552eba6f5ac"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-root",
      "route_id": "route:um-opg-357-a-conjecture-on-iterated-circumcentres-a70060bd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-357-481ca2c114e5",
        "url": "https://www.unsolvedmath.com/problems/OPG-357"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
